          ...
          <ul className="chat-list">
            <li className="chat-item active">
              ...
              <div className="chat-actions" aria-hidden="true">
                <button className="iconSquare edit" title="Edit title" aria-label="Edit chat title" type="button">
                  {/* Pencil icon */}
                ...
                <button className="iconSquare star" title="Favorite" aria-label="Favorite chat" type="button">
                  {/* Star icon (outlined) */}
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="iconSquare trash" title="Delete" aria-label="Delete chat" type="button">
                  {/* Trash icon */}
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
